...
class MCPServer:
    """
    Model Context Protocol (MCP) Server for CompanyOS V2 + Industrial Intelligence.
    This acts as the bridge between the Brains and external platforms.

    Platforms:
      - linkedin, hubspot, instagram, gmail (existing sales/marketing)
    ...
    def execute_tool(self, platform: str, action: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # ── Sales/Marketing Platforms (existing) ──────────────────────────
