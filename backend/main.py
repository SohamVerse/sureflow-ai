...
# a process's stdout defaults to the system codepage (e.g. cp1252) rather than
# UTF-8 unless the console/terminal itself is UTF-8, which raises
# UnicodeEncodeError the first time an emoji is printed and crashes the
# request. Reconfiguring here makes stdout/stderr tolerate any Unicode
# regardless of how this process is launched or its output redirected.
...
async def lifespan(app: FastAPI):
    ...
    setup_constraints()
    print("[OK] Neo4j Strategic Knowledge Graph ready.")
